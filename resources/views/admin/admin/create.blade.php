    ...
    <div class="wrapper wrapper-content animated fadeInRight">
        <div class="col-sm-12">
            <div class="ibox float-e-margins">
                ...
                <form action="/admin/admin" role="form" enctype="multipart/form-data" class="form-horizontal m-t"  method="post">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input id="Identity" name="identity" class="form-control" type="text" aria-required="true" aria-invalid="true" class="error">
                            </div>
                        </div>
               ...
               <div class="form-group">
                   ...
                   <div class="col-sm-8">
                       <input id="confirm_password" name="check_pass" class="form-control" type="password">
                   </div>
               </div>
