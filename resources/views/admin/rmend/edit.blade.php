    ...
    <div class="col-sm-12">
        <div class="ibox float-e-margins">
            ...
            <div class="ibox-content">
                <form action="/admin/rmend/{{$rmend->id}}" role="form" enctype="multipart/form-data"  class="form-horizontal m-t"  method="post" >



                    <input type="hidden" name="_method" value="PUT">
                    <input type="hidden" value="{{$rmend->id}}" name="id">
                    <input type="hidden" name="_token" value="{{csrf_token()}}"/>

                    <div class="form-group">
                        <label class="col-sm-3 control-label">轮播图标题</label>
                        <div class="col-sm-8">
                            <input id="username" name="title" class="form-control" type="text" aria-required="true" aria-invalid="true" class="error" value="{{$rmend->title}}">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <select class="form-control m-b" name="article_id">
                                    <option value="0">--请选择文章链接--</option>
                                @foreach($articles as $article)

                                    @if($rmend ->article_id == $article->id )
                                    <option value="{{$article->id}}"  class="form-control" selected ="selected">{{$article->article_name}}</option>
                                    @else
                                        <option value="{{$article->id}}"  class="form-control">{{$article->article_name}}</option>
                                    @endif
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                ...
                                <div style="width: 300px;margin-top: 10px">
                                    ...
                                    @if ($rmend->img_auth)
                                        <img id="finalImg" src="{{ URL::asset($rmend->img_auth)}}" width="100%" >
                                        <input type="text" id="admin_img" name="img_auth" value="{{$rmend->img_auth}}" width="100%"  style="display: none;">
                                    @else
                                        <img id="finalImg" src="" width="100%" style="border-radius: 60px">
                                        <input type="text" id="admin_img" name="img_auth" value="" width="100%"  style="display: none">
                                    @endif
                                </div>
                            </div>
                        </div>
