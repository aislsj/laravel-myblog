    ...
    <div class="col-sm-12">
        <div class="ibox float-e-margins">
            ...
            <div class="ibox-content">
                <form action="/admin/banner" role="form" enctype="multipart/form-data"  class="form-horizontal m-t"  method="post" >
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input id="username" name="banner_title" class="form-control" type="text" aria-required="true" aria-invalid="true" class="error">
                        </div>
                    </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                ...
                                <div style="width: 300px;margin-top: 10px">
                                    ...
                                    <input type="text" id="admin_img" name="banner_img" value="" width="100%"  style="display: none">
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <select class="form-control m-b" name="articlelink">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                ...
                                <input  name="interlink" class="form-control" type="text" value="" placeholder="填写外部链接时文章链接必须为空">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input  name="banner_sort" class="form-control" type="text" value="">
                        </div>
                    </div>
